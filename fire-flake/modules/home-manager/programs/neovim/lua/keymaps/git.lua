...
vim.keymap.set("n", "<leader>gS", function() h.telescope("git_status") end, { desc = "Git status" })
vim.keymap.set("n", "<leader>gc", function() h.telescope("git_commits") end, { desc = "Git commits" })
